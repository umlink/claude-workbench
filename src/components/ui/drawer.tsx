...
>(({ className, children, side = "left", ...props }, ref) => {
  const sideClasses = {
    ...
    top: "inset-x-0 top-0 h-auto max-h-[80vh] data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top",
    bottom: "inset-x-0 bottom-0 h-auto max-h-[80vh] data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom",
  };
  ...
  return (
    <DrawerPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          "fixed z-50 border bg-background p-6 shadow-lg data-[state=open]:animate-in data-[state=closed]:animate-out duration-300 ease-out",
          sideClasses[side],
          className
        )}
        {...props}
